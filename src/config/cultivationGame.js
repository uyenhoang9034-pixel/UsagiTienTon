...
export const CULTIVATION_CONFIG = {
  enabled: envBoolean('CULTIVATION_ENABLED', true),
  channelId: envString('CULTIVATION_CHANNEL_ID', DEFAULT_CHANNEL_ID),
  adminRoleId: envString('CULTIVATION_ADMIN_ROLE_ID', DEFAULT_ADMIN_ROLE_ID),
  ui: {
    color: envString('CULTIVATION_COLOR', '#F3AFC8'),
    footer: envString('CULTIVATION_FOOTER', 'Usagi Tu Tiên · Nhất niệm nhập tiên đồ, vạn kiếp cầu trường sinh.'),
    image: envString('CULTIVATION_IMAGE_URL', `${RAW_ASSET_BASE}/assets/Games/tutien.png`),
    emojis: {
      ...
      spiritQi: '<a:ttlinhkhi:1547485632971149442>',
      lava: '<a:ttdungnham:1547489239682383902>',
      combat: '<a:ttgiaochien:1547482030747680898>',
      spiritLight: '<a:ttlinhquang:1547489273949978725>',
      blackMist: '<a:ttmansuongden:1547485663065014335>',
    },
    itemEmojis: {
      herb: '<a:ttlinhthao:1547464708318167122>',
      pill: '<a:ttdanduoc:1547449015224762399>',
  ...
  gameplay: {
    maxStamina: envNumber('CULTIVATION_MAX_STAMINA', 100, { min: 1 }),
    cultivateStaminaCost: envNumber('CULTIVATION_CULTIVATE_STAMINA_COST', 5, { min: 0 }),
    cultivateCooldownMs: envNumber('CULTIVATION_CULTIVATE_COOLDOWN_MS', 3 * 60 * 1000, { min: 0 }),
    cultivateBaseMin: envNumber('CULTIVATION_BASE_MIN', 90, { min: 0 }),
    cultivateBaseMax: envNumber('CULTIVATION_BASE_MAX', 150, { min: 1 }),
    spiritStoneMin: envNumber('CULTIVATION_STONE_MIN', 8, { min: 0 }),
    spiritStoneMax: envNumber('CULTIVATION_STONE_MAX', 25, { min: 0 }),
    adventureCooldownMs: envNumber('CULTIVATION_ADVENTURE_COOLDOWN_MS', 6 * 60 * 1000, { min: 0 }),
    breakthroughBaseChance: envNumber('CULTIVATION_BREAKTHROUGH_BASE_CHANCE', 0.88, { min: 0, max: 1 }),
    breakthroughMinChance: envNumber('CULTIVATION_BREAKTHROUGH_MIN_CHANCE', 0.55, { min: 0, max: 1 }),
    breakthroughFailureLossPercent: envNumber('CULTIVATION_BREAKTHROUGH_FAILURE_LOSS_PERCENT', 0.10, { min: 0, max: 1 }),
  },
};
...
export const CULTIVATION_ADVENTURE_EVENTS = [
  { id: 'spirit_gathering', type: 'normal', weight: 28, text: 'Đạo hữu tìm thấy một nơi linh khí nồng đậm, thuận thế ngồi xuống vận công.', cultivationMin: 90, cultivationMax: 170, stonesMin: 12, stonesMax: 35, dropChance: 0.18, drops: [
    { itemId: 'thien_linh_thao', weight: 80, min: 1, max: 2 }, { itemId: 'tu_khi_dan', weight: 20, min: 1, max: 1 },
  ] },
  { id: 'spirit_stone_vein', type: 'treasure', weight: 20, text: 'Sau lớp đá phủ rêu, một mạch Linh Thạch nhỏ bất ngờ lộ ra trước mắt.', cultivationMin: 60, cultivationMax: 130, stonesMin: 55, stonesMax: 120, dropChance: 0.25, drops: [
    { itemId: 'huyen_thiet', weight: 80, min: 1, max: 3 }, { itemId: 'hoi_nguyen_dan', weight: 20, min: 1, max: 1 },
  ] },
  { id: 'ancient_ruin', type: 'treasure', weight: 17, text: 'Một tòa cổ điện phủ đầy bụi thời gian xuất hiện giữa màn sương.', cultivationMin: 120, cultivationMax: 220, stonesMin: 30, stonesMax: 80, dropChance: 0.40, drops: [
    { itemId: 'co_phu', weight: 55, min: 1, max: 1 }, { itemId: 'tu_khi_dan', weight: 30, min: 1, max: 2 }, { itemId: 'vo_danh_kiem_pho', weight: 15, min: 1, max: 1 },
  ] },
  { id: 'great_fortune', type: 'great_fortune', weight: 8, title: '<a:ttcanhgioi:1547448784924180500> ĐẠI CƠ DUYÊN', text: 'Trong khe đá, đạo hữu phát hiện một túi Linh Thạch cùng linh khí do tiền nhân để lại.', cultivationMin: 220, cultivationMax: 360, stonesMin: 120, stonesMax: 260, dropChance: 0.70, drops: [
    { itemId: 'pha_canh_dan', weight: 25, min: 1, max: 1 }, { itemId: 'co_phu', weight: 30, min: 1, max: 1 }, { itemId: 'hoi_nguyen_dan', weight: 25, min: 1, max: 2 }, { itemId: 'vo_danh_kiem_pho', weight: 20, min: 1, max: 1 },
  ] },
  ...
  { id: 'nothing', type: 'empty', weight: 7, text: 'Đạo hữu đi sâu hàng trăm dặm nhưng hôm nay dường như cơ duyên chưa tới.', cultivationMin: 20, cultivationMax: 60, stonesMin: 0, stonesMax: 10, dropChance: 0.08, drops: [
    { itemId: 'thien_linh_thao', weight: 100, min: 1, max: 1 },
  ] },
];
