...
export const HEAVENLY_SECRETS = [
  ...
  { id:'hung_thu_xuat_the', omen:'misfortune', name:'HUNG THÚ XUẤT THẾ', lore:'Hung thú hấp thu dị tượng thiên địa, sức mạnh tăng vọt nhưng chiến lợi phẩm cũng phong phú.', effects:[['boss_damage',0.15],['boss_reward',0.20]], lines:[['👹','Boss Thế Giới','Sát thương Boss **+15%**'],['👹','Boss Thế Giới','Phần thưởng **+20%**']] },
  { id:'ma_trieu_giang_the', omen:'great_misfortune', name:'MA TRIỀU GIÁNG THẾ', lore:'Ma khí che trời, quần ma thức tỉnh. Một trường đại kiếp đang bao phủ Tiên Lộ.', effects:[['boss_hp',0.20],['boss_damage',0.20],['boss_reward',0.35]], lines:[['👹','Boss Thế Giới','Sinh Mệnh Boss **+20%**'],['👹','Boss Thế Giới','Sát thương Boss **+20%**'],['👹','Boss Thế Giới','Phần thưởng Boss **+35%**']] },
