...
export const HEAVENLY_SECRETS = [
  ...
  { id:'dan_ha_chieu_the', omen:'great_fortune', name:'ĐAN HÀ CHIẾU THẾ', lore:'Đan hà phủ trời, hỏa vận tương sinh, đan lô khắp Tiên Lộ cùng lúc cộng minh.', effects:[['alchemy_success',0.12],['alchemy_bonus_pill',0.05]], lines:[['<a:trangtrig34:1546906270108827718>','Luyện Đan','Tỷ lệ thành công **+12%**'],['<a:trangtrig34:1546906270108827718>','Luyện Đan','Cơ duyên luyện thêm Đan **+5%**']] },
  ...
  { id:'dan_kiep_giang_lam', omen:'neutral', name:'ĐAN KIẾP GIÁNG LÂM', lore:'Đan kiếp quấy nhiễu hỏa hầu; vượt qua kiếp khí, đan thành càng dễ kết thêm linh đan.', effects:[['alchemy_success',-0.08],['alchemy_bonus_pill',0.12]], lines:[['<a:trangtrig34:1546906270108827718>','Luyện Đan','Tỷ lệ thành công **-8%**'],['<a:trangtrig34:1546906270108827718>','Luyện Đan','Cơ duyên luyện thêm Đan **+12%**']] },
